...
export class TestService {
  private readonly apiUrl = 'http://localhost:8085/api/test/';  /// Changer par un private readonly comme dans TIG et climberprofile service pour voir si ca marche toujours
